...
for(int r = 0; r < board.length; r++){
		if(board[r][0].equals(board[r][1]) && board[r][0].equals(board[r][2]) && board[r][0].equals(board[r][3]) && board[r][0].equals(board[r][4]) && board[r][0].equals(board[r][5]) && board[r][0].equals(board[r][6]) && board[r][0].equals(board[r][7])){
